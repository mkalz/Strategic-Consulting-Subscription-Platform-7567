  ...
  const steps = [
    {
      number: '01',
      title: 'Brainstorming',
      description: 'Generate ideas and statements related to your focus question with stakeholder participation.',
    },
    {
      number: '02',
      title: 'Structuring',
      description: 'Organize and categorize statements into meaningful clusters and themes.',
    },
    {
      number: '03',
      title: 'Rating',
      description: 'Rate statements on importance and feasibility to identify priorities.',
    },
    {
      number: '04',
      title: 'Analysis',
      description: 'Generate insights and actionable recommendations from structured data.',
    }
  ];
